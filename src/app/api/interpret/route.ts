...
const SECTIONS: SectionDef[] = [
  ...
  { column: 'interp_sun',               name: 'Sun placement',                                         planetKey: 'Sun',        wordCap: 1500 },
  { column: 'interp_moon',              name: 'Moon placement',                                         planetKey: 'Moon',       wordCap: 1500 },
  { column: 'interp_mars',              name: 'Mars placement',                                         planetKey: 'Mars',       wordCap: 1500 },
  { column: 'interp_mercury',           name: 'Mercury placement',                                      planetKey: 'Mercury',    wordCap: 1500 },
  { column: 'interp_jupiter',           name: 'Jupiter placement',                                      planetKey: 'Jupiter',    wordCap: 1500 },
  { column: 'interp_venus',             name: 'Venus placement',                                        planetKey: 'Venus',      wordCap: 1500 },
  { column: 'interp_saturn',            name: 'Saturn placement',                                       planetKey: 'Saturn',     wordCap: 1500 },
  { column: 'interp_rahu',              name: 'Rahu placement',                                         planetKey: 'NorthNode',  wordCap: 1500 },
  { column: 'interp_ketu',              name: 'Ketu placement',                                         planetKey: 'SouthNode',  wordCap: 1500 },
  { column: 'interp_rahu_ketu_axis',    name: 'the full Rahu/Ketu nodal axis story',                                             wordCap: 2000 },
  { column: 'interp_dignities',         name: 'all planetary dignities',                                                         wordCap: 1800 },
  { column: 'interp_aspects',           name: 'all active natal aspects within 5° orb',                                          wordCap: 2500 },
  { column: 'interp_atmakaraka',        name: 'Atmakaraka',                                                                      wordCap: 800  },
  { column: 'interp_amatyakaraka',      name: 'Amatyakaraka',                                                                    wordCap: 800  },
  { column: 'interp_darakaraka',        name: 'Darakaraka',                                                                      wordCap: 800  },
  { column: 'interp_putrakaraka',       name: 'Putrakaraka',                                                                     wordCap: 800  },
  { column: 'interp_bhratikaraka',      name: 'Bhratikaraka',                                                                    wordCap: 800  },
  { column: 'interp_matrikaraka',       name: 'Matrikaraka',                                                                     wordCap: 800  },
  { column: 'interp_gnatikaraka',       name: 'Gnatikaraka',                                                                     wordCap: 800  },
  { column: 'interp_yogas',             name: 'all active yogas',                                                                wordCap: 2500 },
  { column: 'interp_arudha_padas',      name: 'all 12 Arudha Padas',                                                            wordCap: 2000 },
  ...
  { column: 'interp_pratyantar',        name: 'the active Pratyantar Dasha',                                                     wordCap: 800  },
  { column: 'interp_dasha_transitions', name: 'upcoming Dasha transitions',                                                      wordCap: 1200 },
  { column: 'interp_purusharthas',      name: 'the Dharma, Artha, Kama, Moksha balance',                                        wordCap: 1200 },
  { column: 'interp_uranus',            name: 'Uranus placement through a modern lens',                 planetKey: 'Uranus',     wordCap: 700  },
  { column: 'interp_neptune',           name: 'Neptune placement through a modern lens',                planetKey: 'Neptune',    wordCap: 700  },
  { column: 'interp_pluto',             name: 'Pluto placement through a modern lens',                  planetKey: 'Pluto',      wordCap: 700  },
