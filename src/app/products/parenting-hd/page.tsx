...
import ParentingHdProductClient from './ParentingHdProductClient'

export default async function ParentingHdProductPage() {
  ...
  if (!profile?.purchased_products?.includes('parenting_hd_report')) redirect('/products')
